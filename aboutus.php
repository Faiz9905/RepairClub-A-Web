   ...
   <div class="modal " id="signupModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <br>
        <button class="btn btn-primary btn-block" name="senotp" id="sub" data-dismiss="modal"  data-toggle="modal" data-target="#loginModal">Continue</button>
        </form>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        <li class="navlink"><a href="indeex.php">Home</a></li>
