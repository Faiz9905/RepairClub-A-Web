  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="navlink" ><a  href="secondo.php"><span class="glyphicon glyphicon-user"></span> <?php echo $_SESSION[
  "mob"]?></a></li>
...
if (!$conn) {
  ...
  VALUES ( '$name', '$add', '$landmark', '$city', '$date', '$top','$front', '$other', '$msg', '$number')";
