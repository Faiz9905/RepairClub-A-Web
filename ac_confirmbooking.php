...
//$otp = mt_rand(1000,9999);
$message = "Dear User.
Your booking has been confirmed on RepairClub.in
If have any query please call us on 6287777711 or 6287777722.
Thank You.";
...
try {
   ...
   // $_SESSION['mob']= $number;
   // echo "OTP Successfully Send";
    unset( $_SESSION["ac_temp"]);
    echo "

    <script>
    
    alert('Congratulation! Your booking has been done!');
   ...
   {
     echo "<script>
swal ( 'Oops' ,  'OTP did mot match, Plaese try again!' ,  'error' )
</script>";
